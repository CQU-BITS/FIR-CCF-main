...
# Reference : Z. L. Xie, J. L. Chen, Y. Feng, K. Y. Zhang, and Z. T. Zhou, “End to end multi-task learning with attention
#             for multi-objective fault diagnosis under small sample,” Journal of Manufacturing Systems,
#             vol. 62, pp. 301-316, Jan, 2022.
...
from models.MTAGN.attention_block import Flatten, ECA_Layer
...
class MTAGN(nn.Module):
    def __init__(self, in_channels=1, num_classes=5):
        ...
        self.encoder_block_1 = nn.ModuleList([conv_layer([in_channels, 16], 7)])
...
if __name__ == '__main__':
    ...
    model = MTAGN(in_channels=1, num_classes=10).to(device)
    out = model(temp)
    print(out.shape)
